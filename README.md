...
- **Rocket режим** - позволяет получить в <a href="https://developers.google.com/speed/pagespeed/insights/">Google PageSpeed Insights</a> показатели в ``90-100%`` за счет использования на сайте изображения минимального размера.
