...
then
    ...
    echo ''
    echo '------------------------------------------------------------------'
    echo '-----           Откатываемся, осталось 10 сек ...            -----'
    echo '------------------------------------------------------------------'
    echo ''
    ...
    echo '-----     Скопируйте все данные в терминале или сделайте     -----'
    echo '-----        скриншоты и пришлите Нам в GitHub Issues,       -----'
    echo '-----               Мы постараемся разобраться.              -----'
    echo '-----             email: support@cinemapress.org             -----'
    echo '-----             skype: cinemapress                         -----'
    echo '-----                                                        -----'
    echo '------------------------------------------------------------------'
